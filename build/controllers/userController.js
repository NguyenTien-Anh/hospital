  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          _context.next = 6;
          return (0, _userService.handleUserLogin)(email, password);
        case 6:
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          _context2.next = 5;
          return (0, _userService.getAllUsers)(id);
        case 5:
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          data = req.body;
          _context4.next = 3;
          return (0, _userService.editUser)(data);
        case 3:
  ...
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 2:
          _context5.next = 4;
          return (0, _userService.deleteUser)(req.body.id);
        case 4:
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _context6.prev = 0;
          _context6.next = 3;
          return (0, _userService.getALLCodeServices)(req.query.type);
        case 3:
          data = _context6.sent;
        ...
        case 7:
          ...
          console.log('Error get allcode: ', _context6.t0);
