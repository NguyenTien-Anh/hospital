      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return transporter.sendMail({
            from: '"Nguyen_Tien_Anh 👻" <nguyentienanh13072003@gmail.com>',
            // sender address
...
var getBodyEmail = function getBodyEmail(dataSend) {
  var result = '';
  if (dataSend.language === 'vi') {
    result = "\n             <h3>K\xEDnh g\u1EEDi ".concat(dataSend.patientName, "</h3 >\n             <p>B\u1EA1n nh\u1EADn \u0111\u01B0\u1EE3c email n\xE0y v\xEC b\u1EA1n \u0111\xE3 \u0111\u0103ng k\xFD \u0111\u1EB7t l\u1ECBch kh\xE1m b\u1EC7nh t\u1EA1i Nguyen_Tien_Anh.hospital</p>\n             <p>Th\xF4ng tin \u0111\u1EB7t l\u1ECBch kh\xE1m b\u1EC7nh:</p>\n             <div><b>Th\u1EDDi gian: ").concat(dataSend.time, "</b></div>\n             <div><b>B\xE1c s\u0129: ").concat(dataSend.doctorName, "</b></div>\n             <p>N\u1EBFu th\xF4ng tin tr\xEAn l\xE0 ch\xEDnh x\xE1c, vui l\xF2ng nh\u1EA5n v\xE0o li\xEAn k\u1EBFt b\xEAn d\u01B0\u1EDBi \u0111\u1EC3\n             x\xE1c nh\u1EADn v\xE0 ho\xE0n t\u1EA5t th\u1EE7 t\u1EE5c \u0111\u1EB7t l\u1ECBch h\u1EB9n kh\xE1m b\u1EC7nh.\n             </p>\n             <div><a href=").concat(dataSend.redirectLink, " target='_blank'>Nh\u1EA5n v\xE0o \u0111\xE2y</a></div>\n             <div>Xin ch\xE2n th\xE0nh c\u1EA3m \u01A1n!</div>\n         ");
  }
...
var getBodyEmailRemedy = function getBodyEmailRemedy(dataSend) {
  var result = '';
  // if (dataSend.language === 'vi') {
  result = "\n             <h3>Xin ch\xE0o ".concat(dataSend.patientName, "</h3 >\n             <p>B\u1EA1n nh\u1EADn \u0111\u01B0\u1EE3c email n\xE0y v\xEC b\u1EA1n \u0111\xE3 \u0111\u0103ng k\xFD \u0111\u1EB7t l\u1ECBch kh\xE1m b\u1EC7nh t\u1EA1i Nguyen_Tien_Anh.hospital th\xE0nh c\xF4ng</p>\n             <p>Th\xF4ng tin \u0111\u01A1n thu\u1ED1c/h\xF3a \u0111\u01A1n \u0111\u01B0\u1EE3c g\u1EEDi trong file \u0111\xEDnh k\xE8m</p>\n             <div>Xin ch\xE2n th\xE0nh c\u1EA3m \u01A1n!</div>\n         ");
  // }
  // if (dataSend.language === 'en') {
  //     result = `
