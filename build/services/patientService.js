...
var buildUrlEmail = function buildUrlEmail(doctorId, token) {
  var result = '';
  result = "".concat(process.env.URL_REACT, "/verify-booking?token=").concat(token, "&doctorId=").concat(doctorId);
  return result;
};
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 6:
            token = (0, _uuid.v4)();
            _context.next = 9;
            return _mailService["default"].sendSimpleEmail({
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 12:
            resolve({
              errCode: 0,
              errMessage: 'Confirm the appointment succeed!'
            });
            _context2.next = 16;
            break;
          case 15:
